...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		WebDriver driver = new ChromeDriver();   //object for chrome driver, chrome driver will be automatically downloaded on your system based on your chrome browser version 
